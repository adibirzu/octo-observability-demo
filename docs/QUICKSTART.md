...
You're done. Continue with the [workshop labs](../site/workshop/index.md)
...
1. **Run the workshop** — start at [Workshop / Lab 01](../site/workshop/lab-01-first-trace.md).
...
4. **Review the architecture map** — [ARCHITECTURE.md](../ARCHITECTURE.md) explains every service and observability surface in detail.
