...
Mirrored from [`deploy/BOM.md`](https://github.com/example-org/octo-apm-demo/blob/main/deploy/BOM.md)
...
Full row-by-row detail in [`deploy/BOM.md`](https://github.com/example-org/octo-apm-demo/blob/main/deploy/BOM.md).
...
- VCN with public LB subnet, private app subnet, private DB subnet, NAT
  Gateway, Service Gateway, routes, security lists, and NSGs
- Public OCI Load Balancer + WAF
- Two private Compute instances running Podman by default
- Private ATP endpoint, APM, Logging, Log Analytics option, and Stack
  Monitoring Standard
- Resource Manager stack: [`deploy/compute/`](https://github.com/example-org/octo-apm-demo/tree/main/deploy/compute)
