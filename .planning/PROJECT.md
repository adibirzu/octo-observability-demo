...
**In flight:** v1.2 (phoenix-build-migration) — scoped 2026-05-19. Phase 8: Phoenix-native build + registry migration. Requirements BUILD-01..07 defined; seed brief at `.planning/PHASE-8-BRIEF.md`. Next: `/gsd-plan-phase 8`.
