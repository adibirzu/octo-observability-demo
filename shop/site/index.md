...
[:octicons-mark-github-16: Unified Project](https://github.com/adibirzu/octo-observability-demo){ .md-button .md-button--primary }
...
The OCTO Cloud-Native Platform is a **two-service architecture** built on Oracle Cloud Infrastructure, demonstrating how enterprise workloads integrate with OCI's observability, security, and AI services. New deployments should start from the unified [`octo-apm-demo`](https://github.com/adibirzu/octo-observability-demo) repository, which owns the private Compute stack, OKE bootstrap, Resource Manager packages, and current docs.
...
|---|---|---|
| **Unified deploy** | OCTO APM Demo deployment, docs, and Resource Manager stacks | [octo-apm-demo](https://github.com/adibirzu/octo-observability-demo) |
| **Shop service** | Drone Shop Portal | [octo-drone-shop](https://github.com/adibirzu/octo-observability-demo/tree/main/shop) |
| **CRM service** | Enterprise CRM Portal | [enterprise-crm-portal](https://github.com/adibirzu/octo-observability-demo/tree/main/crm) |
