...
| [Private Compute Deployment](https://adibirzu.github.io/octo-observability-demo/getting-started/compute-deployment/) | 60-90 min | OCI tenancy, Resource Manager, private ATP, LB/WAF |
...
- [Unified Deployment Options](https://adibirzu.github.io/octo-observability-demo/getting-started/deployment-options/) — Private Compute, OKE, Resource Manager, and single-VM paths
