...
| [Private Compute Deployment](https://example-org.github.io/octo-apm-demo/getting-started/compute-deployment/) | 60-90 min | OCI tenancy, Resource Manager, private ATP, LB/WAF |
...
- [Unified Deployment Options](https://example-org.github.io/octo-apm-demo/getting-started/deployment-options/) — Private Compute, OKE, Resource Manager, and single-VM paths
