...
Full details: [deploy/resource-manager/README.md](https://github.com/adibirzu/octo-observability-demo/blob/main/deploy/resource-manager/README.md).
...
Or paste [`deploy/vm/cloud-init.yaml`](https://github.com/adibirzu/octo-observability-demo/blob/main/deploy/vm/cloud-init.yaml) into the
OCI Console Compute create form for a one-shot bootstrap. Full
walkthrough: [deploy/vm/README.md](https://github.com/adibirzu/octo-observability-demo/blob/main/deploy/vm/README.md).
