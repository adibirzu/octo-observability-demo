...
| OCI Monitoring SDK | OCI Monitoring (`octo_apm_demo` namespace) | app.health, app.requests.rate, app.errors.rate, app.checkout.count, app.orders.count, app.db.latency_ms, app.crm.sync_age_s, app.inventory.low_stock_products |
