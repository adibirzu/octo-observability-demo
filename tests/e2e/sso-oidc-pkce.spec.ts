 ...
 *   3. Redirect URI: https://drone.${DNS_DOMAIN}/api/auth/sso/callback
 *   4. Post-logout redirect URI: https://drone.${DNS_DOMAIN}/login
...
const SHOP_BASE = process.env.SHOP_BASE_URL || 'https://drone.<DNS_DOMAIN>';
