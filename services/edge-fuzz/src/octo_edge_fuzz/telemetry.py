"""OpenTelemetry setup for the edge-fuzz command."""
...
def init_otel(
    *,
    service_name: str = "octo-edge-fuzz",
...
@contextmanager
def script_span(name: str, *, service_name: str = "octo-edge-fuzz", attributes: dict[str, Any] | None = None):
