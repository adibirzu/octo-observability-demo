"""OpenTelemetry setup for the remediator API and commands."""
...
def init_otel(
    *,
    service_name: str = "octo-remediator",
...
@contextmanager
def script_span(name: str, *, service_name: str = "octo-remediator", attributes: dict[str, Any] | None = None):
