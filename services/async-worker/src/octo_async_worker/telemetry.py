"""OpenTelemetry setup for the async worker process."""
...
def _exporter_config() -> tuple[str, dict[str, str]]:
    endpoint = _first_env(
        "OCTO_WORKER_OTEL_EXPORTER_OTLP_TRACES_ENDPOINT",
        "OCTO_WORKER_OTEL_EXPORTER_OTLP_ENDPOINT",
    ...
    headers = _parse_kv(
        _first_env(
            "OCTO_WORKER_OTEL_EXPORTER_OTLP_TRACES_HEADERS",
            "OCTO_WORKER_OTEL_EXPORTER_OTLP_HEADERS",
            "OTEL_EXPORTER_OTLP_TRACES_HEADERS",
            "OTEL_EXPORTER_OTLP_HEADERS",
        )
    )
    private_key = _first_env("OCTO_WORKER_OCI_APM_PRIVATE_DATAKEY", "OCI_APM_PRIVATE_DATAKEY")
...
def init_otel(
    *,
    service_name: str = "octo-async-worker",
    ...
    attrs.update(_parse_kv(_first_env("OCTO_WORKER_OTEL_RESOURCE_ATTRIBUTES", "OTEL_RESOURCE_ATTRIBUTES")))
...
@contextmanager
def script_span(name: str, *, service_name: str = "octo-async-worker", attributes: dict[str, Any] | None = None):
