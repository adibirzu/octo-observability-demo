"""OpenTelemetry setup for load-control API and scripts."""
...
def init_otel(
    *,
    service_name: str = "octo-load-control",
    service_version: str = "1.0.0",
    resource_attributes: dict[str, Any] | None = None,
) -> trace.Tracer:
    """Initialize an OTLP/HTTP exporter, HTTP clients, and log correlation."""
    global _initialized
    if _initialized:
...
@contextmanager
def script_span(name: str, *, service_name: str = "octo-load-control", attributes: dict[str, Any] | None = None):
