 ...
 *
 * Usage:
 *   k6 run --env DNS_DOMAIN=<DNS_DOMAIN> k6/db_stress.js
 *   k6 run --env SHOP_URL=http://localhost:8080 k6/db_stress.js
 *   k6 run --env DNS_DOMAIN=<DNS_DOMAIN> --env PROFILE=heavy k6/db_stress.js
 *   k6 run --env DNS_DOMAIN=<DNS_DOMAIN> --env CRM_URL=https://crm.<DNS_DOMAIN> k6/db_stress.js
 *
