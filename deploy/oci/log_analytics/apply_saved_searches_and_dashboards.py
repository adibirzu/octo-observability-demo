...
SEARCH_DISPLAY_NAMES = {
    ...
    "genai-token-cost": "Octo APM: GenAI Token & Cost",
    "genai-token-trend": "Octo APM: GenAI Token Throughput",
    "genai-cost-by-model": "Octo APM: GenAI Cost by Model",
    "genai-agent-fanout": "Octo APM: GenAI Agent Fan-out",
    "genai-data-source-mix": "Octo APM: GenAI Data Source Mix",
    "genai-errors": "Octo APM: GenAI Errors & Guardrails",
    "genai-session-rollup": "Octo APM: GenAI Session Rollup",
    "genai-latency-percentiles": "Octo APM: GenAI Latency Percentiles",
    "genai-rag-retrieval": "Octo APM: GenAI RAG Retrieval",
    "genai-judge-by-run": "Octo APM: GenAI Judge Scores by Run",
