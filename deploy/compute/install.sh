...
container_env_vars=(
    ...
    LANGFUSE_ENABLED LANGFUSE_HOST LANGFUSE_PROJECT_NAME
    LANGFUSE_PUBLIC_KEY LANGFUSE_PUBLIC_KEY_FILE LANGFUSE_SECRET_KEY
    LANGFUSE_SECRET_KEY_FILE LANGFUSE_OTEL_EXPORT_ENABLED
