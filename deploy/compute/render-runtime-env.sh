...
values = {
    ...
    "APP_CONTAINER_UID": os.environ.get("APP_CONTAINER_UID", "10001"),
    "APP_CONTAINER_GID": os.environ.get("APP_CONTAINER_GID", "10001"),
    "OCI_COMPARTMENT_ID": os.environ.get("OCI_COMPARTMENT_ID", ""),
    "OCI_REGION": os.environ.get("OCI_REGION", os.environ.get("OCI_REGION_ID", "")),
    "OCI_MONITORING_NAMESPACE": os.environ.get("OCI_MONITORING_NAMESPACE", "octo_apm_demo"),
    ...
    "LANGFUSE_OTEL_EXPORT_ENABLED": os.environ.get("LANGFUSE_OTEL_EXPORT_ENABLED", "false"),
