...
cp "${SCRIPT_DIR}/synthetic-users-job.sh" "${STAGE_DIR}/bootstrap/synthetic-users-job.sh"
...
cp "${SCRIPT_DIR}/systemd/octo-java-apm.service" "${STAGE_DIR}/bootstrap/systemd/octo-java-apm.service"
