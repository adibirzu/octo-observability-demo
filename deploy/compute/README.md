...
[Deploy Full Private Compute Stack to Oracle Cloud](https://cloud.oracle.com/resourcemanager/stacks/create?zipUrl=https://github.com/adibirzu/octo-observability-demo/releases/download/stack-20260602/octo-compute-stack.zip)
...
```bash
curl -I -L https://github.com/adibirzu/octo-observability-demo/releases/download/stack-20260602/octo-compute-stack.zip
```
